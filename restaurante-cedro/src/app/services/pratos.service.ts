...
export class PratosService {
    ...
    getPratos(): Observable<Prato[]> {
        return this.http.get<Prato[]>(this.pratosUrl)
            .pipe(
                catchError(this.handleError('getPratos', []))
            );
    }
    ...
    getPrato(id: number): Observable<Prato> {
        ...
        return this.http.get<Prato>(url)
            .pipe(
                catchError(this.handleError<Prato>('getPratos', null))
            );
    }
    ...
    addPrato(prato: Prato): Observable<Prato> {
        return this.http.post<Prato>(this.pratosUrl, prato, httpOptions)
            .pipe(
                catchError(this.handleError('addPrato', prato))
            );
    }
    ...
    deletePrato(id: number): Observable<{}> {
        ...
        return this.http.delete(url, httpOptions)
            .pipe(
                catchError(this.handleError('deletePrato'))
            );
    }

    updatePrato(prato: Prato): Observable<Prato> {
        const url = `${this.pratosUrl}/${prato.id}`;
        return this.http.put<Prato>(url, prato, httpOptions)
            .pipe(
                catchError(this.handleError('updatePrato', prato))
            );
    }
}