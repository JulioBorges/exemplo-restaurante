...
export class RestaurantesService {
    ...
    getRestaurantes(): Observable<Restaurante[]> {
        return this.http.get<Restaurante[]>(this.restaurantesUrl)
            .pipe(
    ...
    getRestaurante(id: number): Observable<Restaurante> {
        ...
        return this.http.get<Restaurante>(url)
            .pipe(
                catchError(this.handleError<Restaurante>('getRestaurantes', null))
            );
    }
    ...
    searchRestaurantes(term: string): Observable<Restaurante[]> {
        ...
        return this.http.get<Restaurante[]>(url)
            .pipe(
                catchError(this.handleError<Restaurante[]>('searchRestaurantes', []))
            );
    }

    addRestaurante(restaurante: Restaurante): Observable<Restaurante> {
        return this.http.post<Restaurante>(this.restaurantesUrl, restaurante, httpOptions)
            .pipe(
                catchError(this.handleError('addRestaurante', restaurante))
            );
    }
    ...
    deleteRestaurante(id: number): Observable<{}> {
        ...
        return this.http.delete(url, httpOptions)
            .pipe(
                catchError(this.handleError('deleteRestaurante'))
            );
    }
    ...
    updateRestaurante(restaurante: Restaurante): Observable<Restaurante> {
        ...
        return this.http.put<Restaurante>(url, restaurante, httpOptions)
            .pipe(
                catchError(this.handleError('updateRestaurante', restaurante))
            );
    }
}