...
export class PratoComponent implements OnInit {
    ...
    constructor(private _Activatedroute: ActivatedRoute, private pratosService: PratosService,
        public snackBar: MatSnackBar, private router: Router, private restaurantesService: RestaurantesService) {
        this.prato = {
            id: undefined,
            nome: '',
            idRestaurante: null,
    ...
    insertOrUpdate() {
        if (this.prato) {
            if (this.inserir) {
                this.pratosService.addPrato(this.prato)
                    .subscribe(data => {
                        this.prato = data;
                ...
                this.pratosService.updatePrato(this.prato)
                    .subscribe(data => {
